describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it('preenche os campos obrigatórios e envia o formulário', () => {
    ...
    const longText = Cypress._.repeat('abcdefghijklmnopqrstuwyz', 10)

    cy.get('#firstName').type('Carol')
    cy.get('#lastName').type('Maldonado')
    cy.get('#email').type('carolmmv@hotmail.com')
  ...
  it('preencha e limpa os campos nome, sobrenome, email e telefone', () => {
    ...
    cy.get('#lastName')
      .type('Maldonado')
      .should('have.value', 'Maldonado')
      .clear()
      .should('have.value', '')

    cy.get('#email')
      .type('carolmmv@hotmail.com')
      .should('have.value', 'carolmmv@hotmail.com')
      .clear()
      .should('have.value', '')
  ...
  it('marca cada tipo de atendimento', () => {
    ...
    it('seleciona um arquivo da pasta fixtures', () => {
      cy.get('#file-upload')
        .selectFile ('/home/smart/repos/cypress-do-zero-a-nuvem/cypress/fixtures/example.json')
        .should(input => {
      ...
      it('seleciona um arquivo simulando um drag-and-drop', () => {
        cy.get('#file-upload')
          .selectFile ('/home/smart/repos/cypress-do-zero-a-nuvem/cypress/fixtures/example.json' , {action: 'drag-drop'})
          .should(input => {
              expect(input[0].files[0].name).to.equal('example.json')
          })
      })
